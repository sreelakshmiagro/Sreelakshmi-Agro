    ...
    return (
      <div className="flex flex-col gap-1.5 w-full">
        ...
        <textarea
          ...
          className={`w-full bg-white border rounded-md px-4 py-3 font-sans text-sm text-text-primary transition-all duration-200 placeholder:text-text-tertiary focus:border-brand-primary min-h-[120px] ${
            error
